...
public class ArrayItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Array_lenght_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Array_lenght_feature", "_UI_Array_type"),
				 DataTypePackage.Literals.ARRAY__LENGHT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Array_type") + " " + array.getLenght();
	}
