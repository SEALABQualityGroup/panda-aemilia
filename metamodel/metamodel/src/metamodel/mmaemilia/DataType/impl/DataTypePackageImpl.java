...
public class DataTypePackageImpl extends EPackageImpl implements DataTypePackage {
	 ...
	 * @generated
	 */
	public EAttribute getRecord_Field_decl_seq() {
	 ...
	 * @generated
	 */
	public EAttribute getArray_Lenght() {
	 ...
	 * @generated
	 */
	public EAttribute getRangeInt_MinVal() {
		return (EAttribute)rangeIntEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRangeInt_MaxVal() {
		return (EAttribute)rangeIntEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(recordEClass, RECORD__FIELD_DECL_SEQ);

		arrayEClass = createEClass(ARRAY);
		createEAttribute(arrayEClass, ARRAY__LENGHT);
		...
		createEAttribute(rangeIntEClass, RANGE_INT__MIN_VAL);
		createEAttribute(rangeIntEClass, RANGE_INT__MAX_VAL);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRecord_Field_decl_seq(), ecorePackage.getEString(), "field_decl_seq", null, 0, -1, Record.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(arrayEClass, Array.class, "Array", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArray_Lenght(), ecorePackage.getEInt(), "lenght", null, 1, 1, Array.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArray_ArrayElemType(), this.getNormal(), null, "arrayElemType", null, 0, -1, Array.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(listEClass, List.class, "List", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getList_ListElemType(), this.getNormal(), null, "listElemType", null, 0, -1, List.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRangeInt_MinVal(), ecorePackage.getEInt(), "minVal", null, 1, 1, RangeInt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRangeInt_MaxVal(), ecorePackage.getEInt(), "maxVal", null, 1, 1, RangeInt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
