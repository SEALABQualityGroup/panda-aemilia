...
public interface DataTypePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int NORMAL_FEATURE_COUNT = DATA_TYPE_FEATURE_COUNT + 0;
	...
	/**
	 * The feature id for the '<em><b>Field decl seq</b></em>' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int ARRAY__LENGHT = NORMAL_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Array Elem Type</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ARRAY__ARRAY_ELEM_TYPE = NORMAL_FEATURE_COUNT + 1;
	...
	/**
	 * The feature id for the '<em><b>List Elem Type</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int RANGE_INT__MIN_VAL = INTEGER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RANGE_INT__MAX_VAL = INTEGER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RANGE_INT_FEATURE_COUNT = INTEGER_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the attribute list '{@link metamodel.mmaemilia.DataType.Record#getField_decl_seq <em>Field decl seq</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Field decl seq</em>'.
	 * @see metamodel.mmaemilia.DataType.Record#getField_decl_seq()
	 * @see #getRecord()
	 * @generated
	 */
	EAttribute getRecord_Field_decl_seq();
	...
	/**
	 * Returns the meta object for the attribute '{@link metamodel.mmaemilia.DataType.Array#getLenght <em>Lenght</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Lenght</em>'.
	 * @see metamodel.mmaemilia.DataType.Array#getLenght()
	 * @see #getArray()
	 * @generated
	 */
	EAttribute getArray_Lenght();

	/**
	 * Returns the meta object for the containment reference list '{@link metamodel.mmaemilia.DataType.Array#getArrayElemType <em>Array Elem Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Array Elem Type</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '{@link metamodel.mmaemilia.DataType.List#getListElemType <em>List Elem Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>List Elem Type</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link metamodel.mmaemilia.DataType.RangeInt#getMinVal <em>Min Val</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EAttribute getRangeInt_MinVal();

	/**
	 * Returns the meta object for the attribute '{@link metamodel.mmaemilia.DataType.RangeInt#getMaxVal <em>Max Val</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Field decl seq</b></em>' attribute list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute RECORD__FIELD_DECL_SEQ = eINSTANCE.getRecord_Field_decl_seq();
		 ...
		 * @generated
		 */
		EAttribute ARRAY__LENGHT = eINSTANCE.getArray_Lenght();

		/**
		 * The meta object literal for the '<em><b>Array Elem Type</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>List Elem Type</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EAttribute RANGE_INT__MIN_VAL = eINSTANCE.getRangeInt_MinVal();
		 ...
		 * @generated
		 */
		EAttribute RANGE_INT__MAX_VAL = eINSTANCE.getRangeInt_MaxVal();
